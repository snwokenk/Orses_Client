...
class RetrieveData:
    ...
    @staticmethod
    def get_wallet_pubkey_from_db(wallet_id):
        ...
        :return:
        """
        db = Sqlite3Database(dbName=Filenames_VariableNames.wallet_id_dbname, in_folder=Filenames_VariableNames.data_folder)
